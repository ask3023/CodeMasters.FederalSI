    ...
    public class MockDataService
    {
        public List<SolutionMock> BuildSolutions()
        {
            ...
            SolutionMock dotAgile = new SolutionMock()
            {
                ...
                InfoCardUrl = "http://federalsi.azurewebsites.net/api/solution/1/infocard",
                PagerUrl= "http://federalsi.azurewebsites.net/api/solution/1/pager"
            ...
            SolutionMock legacyModernization = new SolutionMock()
            {
                ...
                InfoCardUrl = "http://federalsi.azurewebsites.net/api/solution/4/pager",
                PagerUrl = "http://federalsi.azurewebsites.net/api/solution/4/infocard"
            };
